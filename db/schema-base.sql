...
(
      ...
      aeronautical_enroute_callsign char(10)        null,
      ...
      selective_callsign_identifier char(4)         null,
...
(
      ...
      dm_callsign              char(10)             null,
      proof_of_passing          char(1)              null 
);



create table PUBACC_FC
(
      record_type               char(2)              null,
      unique_system_identifier  integer         not null,
      uls_file_number           char(14)             null,
...
(
      ...
      unique_freq_freeform_id   integer         null ,
...
(
      ...
      antenna_number            int                  null,
      frequency                 numeric(16,8)        null,
      subscriber_callsign      char(10)             null,
      city                      varchar(20)          null,
      state                     char(2)              null,
      lat_degrees               int                  null,
      lat_minutes               int                  null,
...
(
      ...
      unique_lic_freeform_id    integer         null ,
      sequence_number           int              null ,
...
(
      ...
      callsign			char(10)             null,		
      lease_id			char(10)             null,      
      unique_system_identifier_2   integer         null     /*(the licensee) */
);
